...
export const PrivacyPolicy = () => {
    return (
        <div className="position-relative">
            ...
            <h1><strong>Community Guidelines</strong></h1>
            <p>Last updated: November 01, 2021</p>
            <h1>Overview</h1>
            <p>The goal of this community is to inform the Amarillo community about artists and art galleries in
                their area. The site seeks to encourage personal growth through meaningful and thought-provoking
                experiences. In order to meet the goals of this community, it’s important for members to feel like
                they are in a safe place that is populated by people with shared interests. As such, we request
                that you read and adhere to the guidelines that follow.</p>
            <h1>Guidelines</h1>
            <ul>
                <li>Treat others online as you would treat them in real life</li>
                <li>Respect the privacy and personal information of other artists</li>
            ...
            <ul>
                ...
                <li>Use messaging/email irresponsibly</li>
                <li>Use personal contact information made available through the site —including names, mailing
                    addresses, phone numbers, email addresses, social media accounts, or addresses for any
                    commercial, advocacy, promotional, or political purpose
                </li>
            </ul>
            <h1>Consequences</h1>
            <p>We will take action when we see someone violating these guidelines. Sometimes that just means giving
                someone a warning; other times it means revoking certain privileges or accounts entirely. We request
                that all community members report behavior that violates our guidelines to
                CWilson1901@gmail.com.</p>
            <h1>Agreement</h1>
            <p>By logging onto the community and activating your profile, you are considered to be in agreement with
                the terms and conditions listed above.</p>
            ...
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree
                ...
                Policy has been created with the help of the <a
                    href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/">Privacy
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
                        this Agreement) refers to Amarillo Art Galleries.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Amarillo Art Galleries, accessible from <a
                        href="https://amarilloartgalleries.com"
                    >https://amarilloartgalleries.com</a></p>
                </li>
                <li>
            ...
            <ul>
                ...
                <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored
                    objects
                    (or Flash Cookies) to collect and store information about Your preferences or Your
                    activity
                    on our Service. Flash Cookies are not managed by the same browser settings as those used
                    for
            ...
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal
                ...
                >Use of Cookies by Free Privacy Policy</a>.</p>
            ...
            <ul>
                <li>
                    ...
                    <p>Purpose: These Cookies are essential to provide You with services available through
                        ...
                        users
                        and prevent fraudulent use of user accounts. Without these Cookies, the services
                        that
            ...
            <ul>
                ...
                <li>
                    <p><strong>To provide You</strong> with news, special offers and general information
                        about
                        other goods, services and events which we offer that are similar to those that you
                        have
            ...
            <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is
                ...
                security
                or to improve the functionality of Our Service, or We are legally obligated to retain this
                data
            ...
            <ul>
                <li>
                    <p>By email: CWilson1901@gmail.com</p>
                </li>
            </ul>

            {/*Go back to top and go home functions*/}
