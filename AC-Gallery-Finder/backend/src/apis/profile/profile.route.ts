import {getProfileByProfileId, putProfileController, getAllPartialProfiles} from "./profile.controller";
...
ProfileRoute.route("/getAllPartialProfiles")
.get(
    getAllPartialProfiles
)